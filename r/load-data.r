inca150w <- read.csv(file="/tmp/science-project-2013/inca-150w.txt", head=FALSE, sep=",")
colnames(inca150w)[1] <- "temp"
colnames(inca150w)[2] <- "time"

inca75w <- read.csv(file="/tmp/science-project-2013/inca-75w.txt", head=FALSE, sep=",")
colnames(inca75w)[1] <- "temp"
colnames(inca75w)[2] <- "time"

inca60w <- read.csv(file="/tmp/science-project-2013/inca-60w.txt", head=FALSE, sep=",")
colnames(inca60w)[1] <- "temp"
colnames(inca60w)[2] <- "time"

inca40w <- read.csv(file="/tmp/science-project-2013/inca-40w.txt", head=FALSE, sep=",")
colnames(inca40w)[1] <- "temp"
colnames(inca40w)[2] <- "time"

flor13w <- read.csv(file="/tmp/science-project-2013/flor-13w.txt", head=FALSE, sep=",")
colnames(flor13w)[1] <- "temp"
colnames(flor13w)[2] <- "time"

led4w <- read.csv(file="/tmp/science-project-2013/led-4w.txt", head=FALSE, sep=",")
colnames(led4w)[1] <- "temp"
colnames(led4w)[2] <- "time"

pdf('/tmp/science-project-2013/incandescent-graphs.pdf')
...
pdf('/tmp/science-project-2013/other-graphs.pdf')
